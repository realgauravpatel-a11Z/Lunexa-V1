// ============================================================
// LUNEXA — navbar.js  (icon nav + auth-aware profile icon)
// ============================================================
function renderNavbar() {
  ...
  el.innerHTML = `
    <div class="nav-inner">
      <a href="index.html" class="nav-logo">
        <svg class="nav-logo-mark" width="26" height="26" viewBox="0 0 32 32" fill="none">
      ...
      <nav class="nav-center" aria-label="Main navigation">
        ...
        <div class="nav-divider"></div>
        <a href="about.html" class="nav-item" title="About">
      ...
      <div class="nav-right">
        ...
        ${user ? `
          <div class="nav-profile-wrap">
            <button class="nav-profile-btn" onclick="toggleProfileMenu()" title="${user.name}">
            ...
            <div class="nav-profile-menu" id="nav-profile-menu">
              <div class="npm-header">
                <div class="npm-avatar">${user.avatar || user.name.charAt(0).toUpperCase()}</div>
                <div>
                  <div class="npm-name">${user.name}</div>
                  <div class="npm-email">${user.email}</div>
                </div>
              </div>
              <div class="npm-divider"></div>
              <a href="profile.html" class="npm-item">
              ...
              <a href="profile.html#orders" class="npm-item">
              ...
              <a href="wishlist.html" class="npm-item">
              ...
              <div class="npm-divider"></div>
              <button class="npm-item npm-logout" onclick="handleLogout()">
        ...
        ` : `
          <a href="login.html" class="nav-action nav-login-btn" title="Sign In">
            ...
            <span class="nav-tip">Sign In</span>
          </a>
        `}
    ...
    <div class="mobile-menu" id="mobile-menu">
      <a href="index.html" class="mobile-menu-item"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9.5L12 3l9 6.5V20a1 1 0 0 1-1 1H4a1 1 0 0 1-1-1V9.5z"/><path d="M9 21V12h6v9"/></svg> Home</a>
      <a href="products.html" class="mobile-menu-item"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="7" height="7" rx="1"/><rect x="15" y="3" width="7" height="7" rx="1"/><rect x="2" y="14" width="7" height="7" rx="1"/><rect x="15" y="14" width="7" height="7" rx="1"/></svg> All Products</a>
      <div class="mobile-menu-divider"></div>
      <a href="products.html?cat=electronics"  class="mobile-menu-item"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="2" y="3" width="20" height="14" rx="2"/><path d="M8 21h8M12 17v4"/></svg> Electronics</a>
      <a href="products.html?cat=gadgets"      class="mobile-menu-item"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="3"/><path d="M12 2v3M12 19v3M4.22 4.22l2.12 2.12M17.66 17.66l2.12 2.12M2 12h3M19 12h3M4.22 19.78l2.12-2.12M17.66 6.34l2.12-2.12"/></svg> Gadgets</a>
      <a href="products.html?cat=accessories"  class="mobile-menu-item"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M20.38 3.46 16 2a4 4 0 0 1-8 0L3.62 3.46a2 2 0 0 0-1.34 2.23l.58 3.57a1 1 0 0 0 .99.84H6v10c0 1.1.9 2 2 2h8a2 2 0 0 0 2-2V10h2.15a1 1 0 0 0 .99-.84l.58-3.57a2 2 0 0 0-1.34-2.23z"/></svg> Accessories</a>
      <div class="mobile-menu-divider"></div>
      <a href="wishlist.html" class="mobile-menu-item"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg> Wishlist</a>
      <a href="cart.html"     class="mobile-menu-item"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M6 2 3 6v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 0 1-8 0"/></svg> Cart</a>
      ${user ? `
        <a href="profile.html" class="mobile-menu-item"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M4 20c0-4 3.6-7 8-7s8 3 8 7"/></svg> My Profile</a>
        <button class="mobile-menu-item" onclick="handleLogout()" style="width:100%;text-align:left;cursor:pointer;font-family:inherit;"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/></svg> Sign Out</button>
      ` : `
        <a href="login.html"  class="mobile-menu-item"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></svg> Sign In</a>
        <a href="signup.html" class="mobile-menu-item"><svg width="17" height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><line x1="19" y1="8" x2="19" y2="14"/><line x1="22" y1="11" x2="16" y2="11"/></svg> Sign Up</a>
      `}
  ...
  document.addEventListener('click', e => {
    ...
    const pm = document.getElementById('nav-profile-menu');
    const pb = document.querySelector('.nav-profile-btn');
    if (pm && pm.classList.contains('open') && !pm.contains(e.target) && e.target !== pb) {
...
function toggleSearch() {
  const el = document.getElementById('nav-search-expanded');
  if (!el) return;
  const open = el.classList.toggle('open');
  if (open) setTimeout(() => document.getElementById('nav-search-input')?.focus(), 50);
}
...
function toggleProfileMenu() {
  document.getElementById('nav-profile-menu')?.classList.toggle('open');
}
...
function highlightCurrentNav() {
  ...
  document.querySelectorAll('.nav-item').forEach(link => {
    ...
    else if (!cat && (href === path || (path==='' && href==='index.html'))) active = true;
